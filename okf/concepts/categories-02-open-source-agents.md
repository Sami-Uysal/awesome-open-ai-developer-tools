...
okf:
  ...
  generated_at: "2026-07-27T21:16:08.138Z"
---
# Open-Source Agents
...
`Python` · Local-first agent framework
...
`Python + TypeScript` · MIT (classic agent) / Polyform Shield (platform)
...
`TypeScript + Go` · `Apache-2.0` · SDK + self-hostable infra
...
`Go + TypeScript` · `Apache-2.0` · Server + SDK
...
`Python` · `AGPL-3.0` · Library + server
