---
type: concept
title: "Awesome Herramientas de IA de Código Abierto para Desarrolladores [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)"
source: "https://sami-uysal.github.io/awesome-open-ai-developer-tools/README.es/"
path: /README.es/
updated: 2026-07-27
okf:
  generated_by: "@docmd/plugin-okf"
  generated_at: "2026-07-27T20:39:47.558Z"
---
...
`TypeScript` · `Apache-2.0` · Extensión de VS Code
...
`Rust` · `Apache-2.0` · CLI + escritorio
...
`TypeScript` · `Apache-2.0` · Escritorio + web
...
`TypeScript` · `Apache-2.0` · Escritorio
...
`Python` · Framework de agentes local-first
...
`Python + TypeScript` · MIT (agente clásico) / Polyform Shield (plataforma)
...
`TypeScript + Go` · `Apache-2.0` · SDK + infraestructura autoalojable
...
`Go + TypeScript` · `Apache-2.0` · Servidor + SDK
...
`Python` · `AGPL-3.0` · Librería + servidor
...
`TypeScript` · `AGPL-3.0` · Escritorio
...
`Python + Svelte` · `BSD-3-Clause` (con cláusula de marca)
...
`TypeScript` · `Apache-2.0` (con condiciones)
...
`Python + TypeScript` · `Apache-2.0` (con condiciones)
...
`Python` · `GPL-3.0` (con excepciones comerciales)
