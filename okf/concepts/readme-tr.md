---
type: concept
title: "Awesome Açık Kaynak Yapay Zekâ Geliştirici Araçları [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)"
source: "https://sami-uysal.github.io/awesome-open-ai-developer-tools/README.tr/"
path: /README.tr/
updated: 2026-07-27
okf:
  generated_by: "@docmd/plugin-okf"
  generated_at: "2026-07-27T20:39:47.559Z"
---
...
`TypeScript` · `Apache-2.0` · VS Code eklentisi
...
`Rust` · `Apache-2.0` · Kendi sunucunda
...
`TypeScript` · `Apache-2.0` · Masaüstü + web
...
`TypeScript` · `Apache-2.0` · Masaüstü
...
`Python` · Yerel öncelikli ajan çatısı
...
`Python + TypeScript` · MIT (klasik ajan) / Polyform Shield (platform)
...
`TypeScript + Go` · `Apache-2.0` · SDK + kendi sunucunda kurulabilir altyapı
...
`Go + TypeScript` · `Apache-2.0` · Sunucu + SDK
...
`Python` · `AGPL-3.0` · Kütüphane + sunucu
...
`Python + Svelte` · `BSD-3-Clause` (marka koşuluyla)
...
`Python + TypeScript` · `Apache-2.0` (koşullu)
...
`Python` · `GPL-3.0` (ticari istisnalarla)
...
`TypeScript` · `Sustainable Use License` (fair-code, kaynağı görünür)
